...
// Type: MasterDataTable.UnitSkillIntimate
...
{
  [Serializable]
  public class UnitSkillIntimate
  {
    public int ID;
    public int unit_UnitUnit;
    public int skill_BattleskillSkill;

    public static UnitSkillIntimate Parse(MasterDataReader reader)
    {
      return new UnitSkillIntimate()
      {
        ID = reader.ReadInt(),
