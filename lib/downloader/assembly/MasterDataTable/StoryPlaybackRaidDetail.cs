...
// Type: MasterDataTable.StoryPlaybackRaidDetail
...
{
  [Serializable]
  public class StoryPlaybackRaidDetail
  {
    public int ID;
    public string name;
    public int stage_id;
    ...
    public static StoryPlaybackRaidDetail Parse(MasterDataReader reader)
    {
      return new StoryPlaybackRaidDetail()
      {
        ID = reader.ReadInt(),
        ...
        stage_enemy = reader.ReadIntOrNull(),
    ...
    public Tuple<StoryPlaybackTiming, int, object[]> toTuple()
    {
      ...
      switch (this.timing)
      {
        ...
        case StoryPlaybackTiming.defeat_player:
          if (this.stage_enemy.HasValue)
          {
            objArray = new object[1]
            {
              (object) this.stage_enemy.Value
            };
            break;
          }
