...
// Type: MasterDataTable.BattleStageGuestJob
...
{
  [Serializable]
  public class BattleStageGuestJob
  {
    public int ID;
    ...
    public static BattleStageGuestJob Parse(MasterDataReader reader)
    {
      return new BattleStageGuestJob()
      {
        ID = reader.ReadInt(),
