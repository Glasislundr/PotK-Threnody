...
namespace MasterDataTable
{
  ...
  public class TowerPlaybackStoryDetail
  {
    ...
    public static TowerPlaybackStoryDetail Parse(MasterDataReader reader)
    {
      return new TowerPlaybackStoryDetail()
      {
        ID = reader.ReadInt(),
    ...
    public TowerPlaybackStory story
    {
      get
      {
        TowerPlaybackStory story;
        if (!MasterData.TowerPlaybackStory.TryGetValue(this.story_TowerPlaybackStory, out story))
