...
#nullable disable
public class Bugu005ReisouListScene : NGSceneBase
{
  public Bugu005ReisouListMenu menu;
  ...
  {
    Singleton<NGSceneManager>.GetInstance().changeScene("bugu005_reisou_list", stack);
  }
