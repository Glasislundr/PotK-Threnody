...
namespace rapidjson
{
  internal static class DLL
  {
    ...
    public static extern bool _rapidjson_get_value_by_object(
      IntPtr src,
      string name,
      [MarshalAs(UnmanagedType.I1)] out bool isObject,
      out IntPtr dst);
    ...
    public static extern bool _rapidjson_get_key_value_pair_by_object_index(
      IntPtr src,
      uint index,
      [MarshalAs(UnmanagedType.LPStr)] out string key,
      out IntPtr value);
    ...
    public static extern bool _rapidjson_get_value_by_array(
      IntPtr src,
      uint index,
      [MarshalAs(UnmanagedType.I1)] out bool isArray,
      out IntPtr dst);
    ...
    public static extern bool _rapidjson_get_value_by_pointer(
      IntPtr src,
      [MarshalAs(UnmanagedType.LPStr)] string pointer,
      uint pointerLength,
      [MarshalAs(UnmanagedType.I1)] out bool isValid,
      out IntPtr dst);
  }
}
