...
public class BattleUI05TotalScoreRewardPopupMenu : ResultMenuBase
{
  ...
  {
    BattleUI05TotalScoreRewardPopupMenu scoreRewardPopupMenu = this;
    ...
    IEnumerator e = script.Init(scoreRewardPopupMenu.campaign.score_total_rewards[scoreRewardPopupMenu.currentCnt]);
    while (e.MoveNext())
      yield return e.Current;
    e = (IEnumerator) null;
    ...
    if (scoreRewardPopupMenu.currentCnt < scoreRewardPopupMenu.campaign.score_total_rewards.Length)
    {
