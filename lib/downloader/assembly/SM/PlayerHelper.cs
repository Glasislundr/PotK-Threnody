...
namespace SM
{
  ...
  public class PlayerHelper : KeyCompare
  {
    ...
    public BattleskillSkill leader_skill_from_cache
    {
      get
      {
        if (!this.leader_skill_id.HasValue)
          return (BattleskillSkill) null;
        BattleskillSkill battleskillSkill;
        return !MasterData.BattleskillSkill.TryGetValue(this.leader_skill_id.Value, out battleskillSkill) ? (BattleskillSkill) null : battleskillSkill;
      }
    }

    public bool enableLeaderSkill() => true;
