...
// Type: SM.PlayerUnitReservesIntelligence
...
{
  [Serializable]
  public class PlayerUnitReservesIntelligence : KeyCompare
  {
    ...
    public PlayerUnitReservesIntelligence()
    {
    }

    public PlayerUnitReservesIntelligence(Dictionary<string, object> json)
    {
      this._hasKey = false;
