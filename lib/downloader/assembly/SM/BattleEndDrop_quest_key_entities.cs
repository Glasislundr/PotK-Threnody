...
// Type: SM.BattleEndDrop_quest_key_entities
...
{
  [Serializable]
  public class BattleEndDrop_quest_key_entities : KeyCompare
  {
    ...
    public BattleEndDrop_quest_key_entities()
    {
    }

    public BattleEndDrop_quest_key_entities(Dictionary<string, object> json)
    {
      this._hasKey = false;
