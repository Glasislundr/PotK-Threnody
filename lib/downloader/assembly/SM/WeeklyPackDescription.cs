...
{
  [Serializable]
  public class WeeklyPackDescription : KeyCompare
  {
    public string body;
    ...
    public WeeklyPackDescription()
    {
    }

    public WeeklyPackDescription(Dictionary<string, object> json)
    {
      this._hasKey = false;
