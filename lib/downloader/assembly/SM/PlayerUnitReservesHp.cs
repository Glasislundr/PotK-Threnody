...
{
  [Serializable]
  public class PlayerUnitReservesHp : KeyCompare
  {
    ...
    public PlayerUnitReservesHp()
    {
    }

    public PlayerUnitReservesHp(Dictionary<string, object> json)
    {
      this._hasKey = false;
