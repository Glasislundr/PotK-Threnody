...
// Type: SM.PlayerDailyMissionPointDaily
...
{
  [Serializable]
  public class PlayerDailyMissionPointDaily : KeyCompare
  {
    public int?[] received_rewards;
    public int? point;

    public PlayerDailyMissionPointDaily()
    {
    }

    public PlayerDailyMissionPointDaily(Dictionary<string, object> json)
    {
      this._hasKey = false;
