...
// Type: SM.BattleEndDrop_gear_entities
...
{
  [Serializable]
  public class BattleEndDrop_gear_entities : KeyCompare
  {
    ...
    public BattleEndDrop_gear_entities()
    {
    }

    public BattleEndDrop_gear_entities(Dictionary<string, object> json)
    {
      this._hasKey = false;
