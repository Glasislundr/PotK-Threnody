...
// Type: SM.BattleEndDrop_unit_ticket_entities
...
{
  [Serializable]
  public class BattleEndDrop_unit_ticket_entities : KeyCompare
  {
    ...
    public BattleEndDrop_unit_ticket_entities()
    {
    }

    public BattleEndDrop_unit_ticket_entities(Dictionary<string, object> json)
    {
      this._hasKey = false;
