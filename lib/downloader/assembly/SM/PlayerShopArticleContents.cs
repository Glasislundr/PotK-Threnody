...
// Type: SM.PlayerShopArticleContents
...
{
  [Serializable]
  public class PlayerShopArticleContents : KeyCompare
  {
    public int reward_quantity;
    public int reward_type_id;
    public int reward_id;

    public PlayerShopArticleContents()
    {
    }

    public PlayerShopArticleContents(Dictionary<string, object> json)
    {
      this._hasKey = false;
