...
{
  [Serializable]
  public class PlayerStepupPack : KeyCompare
  {
    ...
    public PlayerStepupPack()
    {
    }

    public PlayerStepupPack(Dictionary<string, object> json)
    {
      this._hasKey = false;
      this.next_step = (int) (long) json[nameof (next_step)];
      long? nullable1;
      int? nullable2;
      ...
      this.current_step = (int) (long) json[nameof (current_step)];
      int? nullable3;
