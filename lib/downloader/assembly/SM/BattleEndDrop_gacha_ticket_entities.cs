...
// Type: SM.BattleEndDrop_gacha_ticket_entities
...
{
  [Serializable]
  public class BattleEndDrop_gacha_ticket_entities : KeyCompare
  {
    ...
    public BattleEndDrop_gacha_ticket_entities()
    {
    }

    public BattleEndDrop_gacha_ticket_entities(Dictionary<string, object> json)
    {
      this._hasKey = false;
