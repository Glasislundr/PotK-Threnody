...
// Type: SM.BattleEndDrop_unit_entities
...
{
  [Serializable]
  public class BattleEndDrop_unit_entities : KeyCompare
  {
    ...
    public BattleEndDrop_unit_entities()
    {
    }

    public BattleEndDrop_unit_entities(Dictionary<string, object> json)
    {
      this._hasKey = false;
