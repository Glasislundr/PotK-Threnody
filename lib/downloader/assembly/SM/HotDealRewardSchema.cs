...
{
  [Serializable]
  public class HotDealRewardSchema : KeyCompare
  {
    public int reward_quantity;
    public int reward_type_id;
    public int reward_id;

    public HotDealRewardSchema()
    {
    }

    public HotDealRewardSchema(Dictionary<string, object> json)
    {
      this._hasKey = false;
