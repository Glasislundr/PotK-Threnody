...
{
  [Serializable]
  public class AppendedSkillReward : KeyCompare
  {
    ...
    public AppendedSkillReward()
    {
    }

    public AppendedSkillReward(Dictionary<string, object> json)
    {
      this._hasKey = false;
