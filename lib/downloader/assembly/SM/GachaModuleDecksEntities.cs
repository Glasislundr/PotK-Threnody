...
// Type: SM.GachaModuleDecksEntities
...
{
  [Serializable]
  public class GachaModuleDecksEntities : KeyCompare
  {
    ...
    public GachaModuleDecksEntities()
    {
    }

    public GachaModuleDecksEntities(Dictionary<string, object> json)
    {
      this._hasKey = false;
