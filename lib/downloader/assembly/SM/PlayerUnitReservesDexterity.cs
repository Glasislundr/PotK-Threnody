...
// Type: SM.PlayerUnitReservesDexterity
...
{
  [Serializable]
  public class PlayerUnitReservesDexterity : KeyCompare
  {
    ...
    public PlayerUnitReservesDexterity()
    {
    }

    public PlayerUnitReservesDexterity(Dictionary<string, object> json)
    {
      this._hasKey = false;
