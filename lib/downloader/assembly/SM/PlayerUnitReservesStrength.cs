...
// Type: SM.PlayerUnitReservesStrength
...
{
  [Serializable]
  public class PlayerUnitReservesStrength : KeyCompare
  {
    ...
    public PlayerUnitReservesStrength()
    {
    }

    public PlayerUnitReservesStrength(Dictionary<string, object> json)
    {
      this._hasKey = false;
