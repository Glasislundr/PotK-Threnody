...
// Type: SM.MonthlyPackDescription
...
{
  [Serializable]
  public class MonthlyPackDescription : KeyCompare
  {
    public string body;
    ...
    public MonthlyPackDescription()
    {
    }

    public MonthlyPackDescription(Dictionary<string, object> json)
    {
      this._hasKey = false;
