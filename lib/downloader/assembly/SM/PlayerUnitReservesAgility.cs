...
// Type: SM.PlayerUnitReservesAgility
...
{
  [Serializable]
  public class PlayerUnitReservesAgility : KeyCompare
  {
    ...
    public PlayerUnitReservesAgility()
    {
    }

    public PlayerUnitReservesAgility(Dictionary<string, object> json)
    {
      this._hasKey = false;
