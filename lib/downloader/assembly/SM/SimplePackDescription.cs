...
{
  [Serializable]
  public class SimplePackDescription : KeyCompare
  {
    public string body;
    ...
    public SimplePackDescription()
    {
    }

    public SimplePackDescription(Dictionary<string, object> json)
    {
      this._hasKey = false;
