...
// Type: SM.QuestScoreCampaignDescriptionBlockBodies
...
{
  [Serializable]
  public class QuestScoreCampaignDescriptionBlockBodies : KeyCompare
  {
    public string body;
    public int? kind;
    ...
    public QuestScoreCampaignDescriptionBlockBodies()
    {
    }

    public QuestScoreCampaignDescriptionBlockBodies(Dictionary<string, object> json)
    {
      this._hasKey = false;
