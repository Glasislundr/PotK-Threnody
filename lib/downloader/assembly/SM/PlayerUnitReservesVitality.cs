...
// Type: SM.PlayerUnitReservesVitality
...
{
  [Serializable]
  public class PlayerUnitReservesVitality : KeyCompare
  {
    ...
    public PlayerUnitReservesVitality()
    {
    }

    public PlayerUnitReservesVitality(Dictionary<string, object> json)
    {
      this._hasKey = false;
